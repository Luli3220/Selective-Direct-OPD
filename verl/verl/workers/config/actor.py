...
class ActorConfig(BaseConfig):
    ...
    Args:
        ...
        js_token_filter_enabled (bool): Whether to keep only high-JS response tokens in actor loss.
        js_top_fraction (float): Per-response fraction of highest-JS tokens retained for actor loss.
